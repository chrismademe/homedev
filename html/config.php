...
*/
$devtools = array(
	array( 'name' => 'Github', 'url' => 'http://github.com/chrismademe' ),
	array( 'name' => 'SIL cPanel', 'url' => 'http://cp.searchitlocal.co.uk' ),
	array( 'name' => 'Resknow cPanel', 'url' => 'http://resknowcloud.com:2086' )
);
...
//	'dirname' => array( 'displayname' => 'DisplayName', 'adminurl' => 'http://something/admin' ),
	'framework' => array( 'displayname' => 'PHP Site Framework' )
	);
